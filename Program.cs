    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] indicatii = {"Setul de probleme 2 (Secvente):",
                                  ...
                                  $"12. Cate grupuri de numere consecutive diferite de zero sunt intr-o secventa de n numere.{Environment.NewLine}    Considerati fiecare astfel de grup ca fiind un cuvant, zero fiind delimitator de cuvinte.",
                                            // De ex. pentru secventa 1, 2, 0, 3, 4, 5, 0, 0, 6, 7, 0, 0 raspunsul este 3.
                                  $"13. O <secventa crescatoare rotita> este o secventa de numere care este in ordine crescatoare{Environment.NewLine}    sau poate fi transformata intr-o secventa in ordine crescatoare prin rotiri succesive.{Environment.NewLine}    Determinati daca o secventa de n numere este o secventa crescatoare rotita.",
                                            // Rotire cu o pozitie spre stanga = toate elementele se muta cu o pozitie spre stanga & primul element devine ultimul
                                  $"14. O <secventa monotona rotita> este o secventa de numere monotona{Environment.NewLine}    sau poate fi transformata intr-o secventa montona prin rotiri succesive.{Environment.NewLine}    Determinati daca o secventa de n numere este o secventa monotona rotita.",
                                  $"15. O secventa bitonica este o secventa de numere care incepe monoton crescator si continua monoton descrecator.    Se da o secventa de n numere. Sa se determine daca este bitonica.",
                                            // De ex. 1,2,2,3,5,4,4,3 este o secventa bitonica.
                                  $"16. O <secventa bitonica rotita> este o secventa bitonica{Environment.NewLine}    sau una ca poate fi transformata intr-o secventa bitonica prin rotiri succesive.{Environment.NewLine}    Se da o secventa de n numere. Se cere sa se determine daca este o secventa bitonica rotita.",
